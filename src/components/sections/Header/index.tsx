...
function LanguageSwitcher() {
  ...
  return (
    <button
      onClick={() => router.push(asPath, asPath, { locale: other })}
  ...
  return (
    <header
      className={classNames(
        'sb-component sb-component-header',
        colors,
        'relative shadow-header',
...
// ####################################
// # Variant: Logo Left, Nav Centered
// ####################################
...
// ####################################
// # Variant: Logo Centered, Nav Left
// ####################################
...
// ####################################
// # Variant: Logo Centered, Nav Centered
// ####################################
